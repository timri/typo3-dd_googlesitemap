...
<xsl:stylesheet version="1.0"
    ...
    <!-- match root-xml-tag to document structure + styles -->
    <xsl:template match="/">
        <html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <body>
                ...
                <script type="text/javascript"
                        src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.slim.js"
                        integrity="sha384-sh6iinGECmk2oNezd0GDVuXqoHrZzF3PTML2nyt/lC61v2p1W7hGll/JkRFCOcMf"
                        crossorigin="anonymous"></script>
                <script type="text/javascript"
                        src="https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.29.6/js/jquery.tablesorter.min.js"
                        integrity="sha384-Mmb+dulSa55Wcw2eU9vi7u5EBmMH7eIEagEOTWvDA9fQfnU42RjphaAfCfiROm+p"
                        crossorigin="anonymous"></script>
